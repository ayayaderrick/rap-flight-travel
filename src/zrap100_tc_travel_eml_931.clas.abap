"! @testing BDEF:ZRAP100_R_TRAVELTP_931
CLASS zrap100_tc_travel_eml_931 DEFINITION
  PUBLIC
  FINAL
  ...
  PRIVATE SECTION.
    ...
    METHODS:
      ...
      create_with_action FOR TESTING RAISING cx_static_check.   " CUT: create with action call and commit

ENDCLASS.



CLASS zrap100_tc_travel_eml_931 IMPLEMENTATION.
  METHOD class_setup.
    " create the test doubles for the underlying CDS entities
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                      i_for_entities = VALUE #(
                        ( i_for_entity = 'ZRAP100_R_TravelTP_931' ) ) ).
  ...
  METHOD create_with_action.
   ...
   MODIFY ENTITIES OF ZRAP100_R_TravelTP_931
    ENTITY Travel
   ...
   SELECT * FROM ZRAP100_R_TravelTP_931 INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
