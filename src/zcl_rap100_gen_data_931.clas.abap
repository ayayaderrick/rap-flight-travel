CLASS zcl_rap100_gen_data_931 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_931 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA:
      group_id   TYPE string VALUE '931',
...
*   clear data
    ...
    DELETE FROM zrap100_atrav931.
    DELETE FROM zrap100_dtrav931.

*   insert travel demo data
    INSERT zrap100_atrav931 FROM (
    ...
    out->write( |[RAP 100] Demo data generated for tabel ZRAP100_ATRAV{ group_id }.| ).
